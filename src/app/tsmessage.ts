...
export const PINCODE_IS_REQUIRED                          = "Pin Code is required.";
export const MINIMUM_ONE_PINCODE_IS_REQUIRED			  = "Minimum One Pin Code is required."
export const MAXIMUM_6_DIGIT_ALLOW                        = "Maximum 6 digit allow.";
export const MINIMUM_6_DIGIT_ALLOW						  = "Minimum 6 digit allow.";
export const ALREADY_EXISTS                               = "Already exist.";
...
export const DO_YOU_WANT_TO_ACTIVATE_DRIVER               = "Do you want to Activate Driver?";
export const DO_YOU_WANT_TO_DEACTIVATE_DRIVER             = "Do you want to Deactivate Driver?";
...
export const PLEASE_SELECT_ATLEAST_ONE_DASHBOARD          = "Please select atleast one dashboard.";